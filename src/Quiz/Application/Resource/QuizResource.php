 ...
 * @method \App\Quiz\Infrastructure\Repository\QuizRepository getRepository()
 ...
 */
class QuizResource extends RestResource
{
    /**
     * @param \App\Quiz\Infrastructure\Repository\QuizRepository $repository
     */
